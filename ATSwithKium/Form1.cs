...
namespace ATSwithKium {
    public partial class Form1 : Form {
        ...
        private string _account = "8148114911";
        ...
        //ActiveX정의 실시간데이터를 받은 시점을 알려준다f 코딩 테스트 endgliner
        ...
        public void dataSetBuyList(int posAmt) {
            ...
            if (rowCnt == 0) {
                ...
                for (int i = 0; i < rowCnt; i++) {
                    LogWrite.TrxLog(dataGridBuyList.Rows[i].Cells[1].Value.ToString());
                    if (txtBuyJongMok.Text.Trim().Equals(dataGridBuyList.Rows[i].Cells[1].Value.ToString())) {
